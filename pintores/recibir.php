...
<?php
  ...
  if (mysqli_query($conn, $sql1)){
    echo "<br/>"."Pintor 1 - Inserción correcta"."<br/>";
  } else {
    echo "Error: " . mysqli_error($conn);
  }

  if (mysqli_query($conn, $sql2)){
    echo "Pintor 2 - Inserción correcta"."<br/>";
  } else {
    echo "Error: " . mysqli_error($conn);
  }

  if (mysqli_query($conn, $sql3)){
    echo "Pintor 3 - Inserción correcta"."<br/>";
  } else {
    echo "Error: " . mysqli_error($conn);
  }

  if (mysqli_query($conn, $sql4)){
    echo "Pintor 4 - Inserción correcta"."<br/>";
  } else {
    echo "Error: " . mysqli_error($conn);
  }

  if (mysqli_query($conn, $sql5)){
    echo "Pintor 5 - Inserción correcta"."<br/>";
  } else {
    echo "Error: " . mysqli_error($conn);
  }
